...
3. **Tabela quando houver mais de três linhas, com o resultado inteiro.**
   Use uma tabela Markdown com cabeçalhos em português e **mostre todas as
   linhas que você recebeu** — quem perguntou "quais CDs estão em ruptura"
