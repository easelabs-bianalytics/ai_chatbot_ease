...
- [x] Lista de conversas agrupada por período (Hoje, Ontem, Últimos 7 dias, Este mês, Mais antigas): com vinte conversas no mesmo dia, "Hoje, 14:36" repetido não ajuda a achar nada
